...
HD_PWD='C:/Users/Administrator/Documents/project_10blaze/project_10blaze.runs/microblazeblock_axi_uartlite_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblazeblock_axi_uartlite_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblazeblock_axi_uartlite_0_0.tcl
