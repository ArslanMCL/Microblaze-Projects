...
HD_PWD='C:/Users/Administrator/Documents/project_10blaze/project_10blaze.runs/microblazeblock_mig_7series_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblazeblock_mig_7series_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblazeblock_mig_7series_0_1.tcl
