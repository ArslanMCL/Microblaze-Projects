...
HD_PWD='C:/Users/Administrator/Documents/project_10blaze/project_10blaze.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log microblazeblock_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source microblazeblock_wrapper.tcl -notrace
