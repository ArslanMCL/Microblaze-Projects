...
HD_PWD='C:/Users/Administrator/Documents/project_10blaze/project_10blaze.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblazeblock_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblazeblock_wrapper.tcl
